...
def calculate_demographic_data(print_data=True):
    ...
    lower_education = len(df[df["education"].isin(["Bachelors","Masters","Doctorate"])==False])
    ...
    lower_education_rich = round((len(df[df["education"].isin(["Bachelors","Masters","Doctorate"])==False][df["salary"]==">50K"])/lower_education)*100,1)
